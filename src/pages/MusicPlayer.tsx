  ...
  return (
    <div className="container mx-auto animate-fade-in">
      <h1 className="text-3xl font-bold mb-8 flex items-center">
        <span className="mr-2">K-pop Music Player</span>
      ...
      {music.length === 0 ? (
        <div className="glass-effect p-8 text-center rounded-xl">
          <h2 className="text-2xl font-semibold mb-4">Плейлист пуст</h2>
          <p className="text-gray-600">
            Добавьте свои первые музыкальные треки через панель администратора!
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white bg-opacity-10 rounded-xl p-6">
            <h2 className="text-xl font-bold mb-4">K-pop Playlist</h2>
          ...
          <div className="glass-effect p-6 rounded-xl flex flex-col">
            {currentTrack ? (
              ...
              <div className="flex-grow flex flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-600">
                  Добавьте музыку через панель администратора
                </p>
              </div>
            )}
          </div>
